# FHDS Adaptive Triggers

> 在 Steam Deck 上感受 Forza Horizon 的 DualSense 自适应扳机效果
...
FHDS Adaptive Triggers 是一个 Decky Loader 插件，将 [Forza-Horizon-DualSense-Python](https://github.com/HamzaYslmn/Forza-Horizon-DualSense-Python) 的自适应扳机功能带入 Steam Deck 的游戏模式。无需桌面模式，无需手动启动脚本——直接在游戏模式中通过 Decky 插件商店安装，即开即用。
...
- 双扳机自适应效果，基于 Forza Horizon UDP 遥测数据
...
1. 在 Decky 中打开 FHDS Triggers 设置面板
...
FHDS Adaptive Triggers brings the [Forza-Horizon-DualSense-Python](https://github.com/HamzaYslmn/Forza-Horizon-DualSense-Python) experience to Steam Deck's gaming mode via Decky Loader. No desktop mode required — install it from the Decky plugin store and it runs automatically.
...
- DualSense adaptive triggers driven by Forza Horizon UDP telemetry
